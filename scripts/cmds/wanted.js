...
module.exports = {
  config: {
    name: "wanted",
    version: "1.1",
    author: "MOHAMMAD AKASH |fixed by Acs kabir",
    countDown: 5,
    role: 0,
  ...
  onStart: async function ({ event, message, api, usersData }) {
    try {
      ...
      const avatarPath = cacheDir + "/wanted_avatar.jpg";
      const outputPath = cacheDir + "/wanted_poster.jpg";
